...
def main():
    ...
    if "ogb" in args.dataset:
        ...
        dataset_eval_ = PygGraphPropPredDataset(
            name=args.dataset,
            root=args.data_root,
        )
        (
    ...
    def run(run_id):
        ...
        for epoch in range(
            ...
            logger.info(
                "Total parameters: {}",
                utils.num_total_parameters(model),
            )
            logger.info(
                "Trainable parameters: {}",
                utils.num_trainable_parameters(model),
            )
            loss = train(
                model,
                device,
        ...
        return (
            best_valid_perf[dataset.eval_metric],
            best_test_perf[dataset.eval_metric],
        )
